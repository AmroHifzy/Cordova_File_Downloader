...
var filename = "outfile.html";
$(document).ready(function() {
	document.addEventListener("deviceready", onDeviceReady, false);
});

var fileURL = "https://deution.com//outfile.html";
var imagePath = "cordova.file.applicationStorageDirectory";
	...
	var fileTransfer = new FileTransfer();
     $('#download').click( function() 
		...
		function gotFileEntry(fileEntry) {										
				var uri = encodeURI("https://deution.com//outfile.html");			
